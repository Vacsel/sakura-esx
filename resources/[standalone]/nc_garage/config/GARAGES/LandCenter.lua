return {
	...
	spawner = {
		from = {
			{
				coords = vector3(221.8278961181641, -803.9932250976562, 30.68116760253906),
				radius = 1.5
			},			
		},
		to = {
			{
				coords = vector3(223.1200, -801.6420, 30.2392), 
				heading = 248.2127
			},
	...
	others = {
		...
		object = {
			...
			heading = 249.8471-180,											-- Heading ของ Object
