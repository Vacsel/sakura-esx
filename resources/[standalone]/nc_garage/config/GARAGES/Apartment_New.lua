return {
	...
	spawner = {
		from = {
			{
				coords = vector3(-905.1, -1292.33, 5.01),
				radius = 1.5
			},			
		},
		to = {
			{
				coords = vector3(-907.76, -1293.39, 5.17), 
				heading = 19.73
			},
			{
				coords = vector3(-910.43, -1294.34, 5.18), 
				heading = 19.73
			},
		}
	},
	...
	others = {
		blip = {
			...
			name = '<font face="font4thai">Apartment Garage</font>',									-- ชื่อของ Blip
		...
		marker = {
			...
			color = {
				idle = { r = 255, g = 103, b = 203, a = 80 },		-- สีของ Marker ขณะ Idle (rgba)
				active = { r = 255, g = 103, b = 203, a = 150 }	-- สีของ Marker ขณะเข้าใกล้ (rgba)
			}
		},
		object = {
