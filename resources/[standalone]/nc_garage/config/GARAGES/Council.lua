return {
	...
	spawner = {
		from = {
			{
				coords = vector3(-462.8516, 1119.3785, 326.9017),
				radius = 1.5
			},
		},
		to = {
			{
				coords = vector3(-461.5639, 1124.2755, 326.9012), 
				heading = 255.1183
			},
		}
	},
	...
	others = {
		...
		marker = {
			...
			color = {
				idle = { r = 60, g = 135, b = 245, a = 150 },		-- สีของ Marker ขณะ Idle (rgba)
				active = { r = 10, g = 105, b = 245, a = 180 }		-- สีของ Marker ขณะเข้าใกล้ (rgba)
			}
		},
		object = {
