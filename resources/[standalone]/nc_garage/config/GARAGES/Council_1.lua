return {
	...
	spawner = {
		from = {
			{
				coords = vector3(-395.8376, 1132.5901, 326.9012),
				radius = 1.5
			},
			{
				coords = vector3(-403.1911, 1134.7687, 326.9012),
				radius = 1.5
			},	
		},
		to = {
			{
				coords = vector3(-392.1142, 1131.7220, 326.4768), 
				heading = 165.7171
			},
			{
				coords = vector3(-399.3095, 1133.8436, 326.4768), 
				heading = 166.5204
			},
		}
	},
	...
	others = {
		...
		object = {
			...
			heading = 166.5204-180,											-- Heading ของ Object
