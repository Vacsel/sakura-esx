return {
	...
	spawner = {
		from = {
			{
				coords = vector3(200.6014, 1221.6904, 225.036),
				radius = 1.5
			},			
		},
		to = {
			{
				coords = vector3(200.6014, 1221.6904, 225.0361), 
				heading = 283.0006
			},
		}
	},
	options = {
		...
		trunk = {
			enable = false,											-- เปิดใช้งานระบบเปิดช่องเก็บของท้ายยานพาหนะ
	...
	others = {
		...
		marker = {
			...
			color = {
				idle = { r = 255, g = 103, b = 223, a = 80 },		-- สีของ Marker ขณะ Idle (rgba)
				active = { r = 255, g = 103, b = 223, a = 150 }	-- สีของ Marker ขณะเข้าใกล้ (rgba)
			}
		},
		object = {
			enable = true,											-- แสดง Object ที่ต้องการ
			model = `london_un_candy_work_carblue`,				-- Model ของ Object
			heading = 283.0006,											-- Heading ของ Object
			place_on_ground = false,									-- วาง Object ลงบนพื้น
			z_offset = -0.32,										-- ระยะที่ต้องการเพิ่มหรือลดลงในแนวแกน Z (+ เมื่อต้องการให้สูงขึ้น | - เมื่อต้องการให้ต่ำลง)
		...
		ped = {
			...
			z_offset = -0.9,										-- ระยะที่ต้องการเพิ่มหรือลดลงในแนวแกน Z (+ เมื่อต้องการให้สูงขึ้น | - เมื่อต้องการให้ต่ำลง)
