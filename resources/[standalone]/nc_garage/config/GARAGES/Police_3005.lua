return {
	...
	spawner = {
		from = {
			{
				coords = vector3(-441.3762, 6026.0312, 31.3406), --450.4111, -1011.6362, 28.4931, 182.3207
				radius = 1.5
			},	
		},
		to = {
			{
				coords = vector3(-434.8900, 6031.3315, 31.3406), -- 440.0154, -1021.4038, 28.6222, 90.6816
				heading = 29.3768
			},
		}
	},
	...
	others = {
		...
		marker = {
			...
			color = {
				idle = { r = 60, g = 60, b = 208, a = 150 },		-- สีของ Marker ขณะ Idle (rgba)
				active = { r = 50, g = 50, b = 204, a = 180 }		-- สีของ Marker ขณะเข้าใกล้ (rgba)
			}
		},
		object = {
