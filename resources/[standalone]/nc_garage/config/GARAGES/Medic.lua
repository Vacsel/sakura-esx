return {
	...
	spawner = {
		from = {
			{
				coords = vector3(1117.1024, -1509.0824, 34.8423),
				radius = 1.5
			},	
		},
		to = {
			{
				coords = vector3(1116.2479, -1505.9109, 34.2691), 
				heading = 271.0208
			},
			{
				coords = vector3(1116.1246, -1502.4088, 34.2685),
				heading = 271.0208
			},
			{
				coords = vector3(1116.1895, -1498.9855, 34.2686),
				heading = 271.0208
			}
		}
	},
	...
	others = {
		...
		marker = {
			...
			color = {
				idle = { r = 20, g = 60, b = 210, a = 150 },		-- สีของ Marker ขณะ Idle (rgba)
				active = { r = 10, g = 50, b = 200, a = 180 }		-- สีของ Marker ขณะเข้าใกล้ (rgba)
			}
		},
		object = {
			enable = false,											-- แสดง Object ที่ต้องการ
			model = `ch_prop_ch_service_locker_01a`,				-- Model ของ Object
			heading = 90.0-180,											-- Heading ของ Object
