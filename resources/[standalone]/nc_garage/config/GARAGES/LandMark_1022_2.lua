return {
	...
	spawner = {
		from = {
			{
				coords = vector3(1706.8199462890625, 3761.7900390625, 34.2599983215332),
				radius = 1.5
			},			
		},
		to = {
			{
				coords = vector3(1708.449951171875, 3775.139892578125, 34.5099983215332), 
				heading = 218.26
			},
	...
	others = {
		blip = {
			enable = true,											-- แสดง Blip ในแผนที่
		...
		object = {
			...
			heading = 318.0891-180,											-- Heading ของ Object
