return {
	...
	spawner = {
		from = {
			{
				coords = vector3(1196.4529, -1491.9431, 34.6929),
				radius = 2.0
			}
		},
		to = {
			{
				coords = vector3(1201.0734, -1492.0791, 34.2707),
				heading = 178.1176
			}
		}
	},
	...
	others = {
		...
		object = {
			...
			heading = 178.1176,										-- Heading ของ Object
		...
		ped = {
			...
			heading = 178.1176,										-- Heading ของ Ped
			z_offset = 0.0,											-- ระยะที่ต้องการเพิ่มหรือลดลงในแนวแกน Z (+ เมื่อต้องการให้สูงขึ้น | - เมื่อต้องการให้ต่ำลง)
