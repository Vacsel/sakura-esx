return {
	...
	spawner = {
		from = {
			{
				coords = vector3(417.2902, -1007.8021, 29.5096),  -- 423.2078, -1013.9814, 29.0432, 88.9201
				radius = 2.0
			}
		},
		to = {
			{
				coords = vector3(408.2610, -1005.1556, 29.2663),  -- 414.5174, -1013.9579, 29.2788, 89.3992
				heading = 90.3586
			}
		}
	},
	...
	others = {
		...
		object = {
			...
			heading = 89.64,										-- Heading ของ Object
