return {
	...
	spawner = {
		from = {
			{
				coords = vector3(-95.6905, -2025.3789, 18.0170),
				radius = 2.0
			}
		},
		to = {
			{
				coords = vector3(-88.0691, -2026.5789, 17.5924),
				heading = 352.0628
			},
			{
				coords = vector3(-91.8305, -2026.0267, 17.5925),
				heading = 352.0628
			}
		}
	},
	...
	others = {
		...
		object = {
			...
			heading = 17.92888450622558,										-- Heading ของ Object
		...
		ped = {
			...
			heading = 17.92888450622558,										-- Heading ของ Ped
			z_offset = 0.0,											-- ระยะที่ต้องการเพิ่มหรือลดลงในแนวแกน Z (+ เมื่อต้องการให้สูงขึ้น | - เมื่อต้องการให้ต่ำลง)
