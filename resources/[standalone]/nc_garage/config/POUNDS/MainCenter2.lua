return {
	...
	spawner = {
		from = {
			{
				coords = vector3(403.3599853515625, -1626.3800048828125, 29.2900009155273),
				radius = 2.0
			}
		},
		to = {
			{
				coords = vector3(401.3399963378906, -1637.8699951171875, 29.29000091552734), 
				heading = 232.53
			}
		}
	},
	...
	others = {
		...
		object = {
			...
			heading = 232.53,										-- Heading ของ Object
