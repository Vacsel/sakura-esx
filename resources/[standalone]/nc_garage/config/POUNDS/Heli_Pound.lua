return {
	...
	spawner = {
		from = {
			{
				coords = vector3(344.2751, -579.5344, 74.1642),
				radius = 2.0
			}
		},
		to = {
			{
				coords = vector3(351.9890, -588.0450, 74.1642), 
				heading = 36.2626
			}
		}
	},
	options = {
		send_to_garage = {
			enable = false,											-- เปิดใช้งานระบบส่งยานพาหนะเข้าการาจ
			...
			fuel = 30												-- ระดับเชื้อเพลงของยานพาหนะเมื่อพาวน์เสร็จ
		},
		spawn = {
	...
	others = {
		...
		object = {
			...
			model = `ch_chint03_plan_lockers`,						-- Model ของ Object
			heading = 212.15,										-- Heading ของ Object
