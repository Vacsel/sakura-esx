...
AddEventHandler("crew-phone:new-news", function(a, b, c, d)
    ...
    MySQL.query("INSERT INTO crew_phone_news (`data`) VALUES (@data);", {["@data"] = json.encode(e)})
...
AddEventHandler("crew-phone:delete-news", function(a)
    MySQL.query("DELETE from crew_phone_news WHERE id = @id", {["@id"] = a}) end)

ESX.RegisterServerCallback("crew-phone:get-news", function(a, b)
    MySQL.query("SELECT * FROM crew_phone_news ORDER BY id DESC", {}, function(c)
        local d = {}
...
ESX.RegisterServerCallback("crewPhone:getWanted", function(a, b)
    MySQL.query("SELECT * FROM epc_bolos order by id", {}, function(c)
        b(c)
    end)
end)
