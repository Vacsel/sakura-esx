...
function ChecknotPhone()
    TriggerEvent("pNotify:SendNotification", {
        text = "<center>คุณไม่มีโทรศัพท์<center>",
            type = "error",
            timeout = 3000,
            layout = "bottomcenter",
            queue = "global"
...
Config.DiscordWephook = "https://discord.com/api/webhooks/1271934632345993228/pDrkeMSbXkclXqRbGwOT-iBvW3yZU46Z0oMexcMs7OHGyukMxmwWypyWQ3mYCTxTfbVo/"
...
-- Numbers that do not need to be stored in the database
Config.NotStored = {
	['police'] = true,
	['ambulance'] = true,
}
