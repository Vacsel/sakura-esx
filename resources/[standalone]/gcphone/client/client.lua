...
Citizen.CreateThread(function()
  ...
  Wait(3000)
  TriggerEvent('phone:RequestBankphone')
  Wait(30000)
  if messagesft == false then
    messagesft = true
    TriggerServerEvent('gcPhone:sv:allMessage')
...
RegisterCommand('openxclosephone', togglePhone)
RegisterKeyMapping('openxclosephone', 'Toggle Phone', 'keyboard', 'F1')
...
AddEventHandler('crew:updatePhone', function(_myPhoneNumber,  _contacts)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      -- exports['screenshot-basic']:requestScreenshotUpload(GetConvar('gcphone_webhooks', ''), 'file', function(data)
      ...
      exports['screenshot-basic']:requestScreenshotUpload(GetConvar('gcphone_webhooks', ''), data.field, function(data)
      ...
      -- exports['screenshot-basic']:requestScreenshotUpload(GetConvar('gcphone_webhooks', Config.DiscordWephook), data.field, function(data)
      --   local image = json.decode(data)
      --   DestroyMobilePhone()
      --   CellCamActivate(false, false)
      --   cb(json.encode({ url = image.attachments[1].proxy_url }))
